...
import { Heading, Text, MailLink, Wrapper, SocialIconsWrapper } from "./FooterStyles";
...
const Footer = () => {
	return (
		<div>
			...
			<Text>
				Feel free to reach out if you're looking for a <br /> developer, have a question, or
